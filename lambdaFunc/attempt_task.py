...
# Instanciate the database API
db = word_db.db()
pg = phrase_generator.phrase_generator()

class attempt_task(base.state_base):
    ...
    def on_intent(self, intent_request, session):
        ...
        if intent_name   == "giving_an_answer_to_verify":
    ...
    # In the unhandled case, we assume the user has input some incorrect information
    # Prompt the user to try again
